...
In practice, it would start to get tedious if every page on Wikipedia had to be written in HTML. So instead, it can be helpful to store encyclopedia entries using a lighter-weight human-friendly markup language. Wikipedia happens to use a markup language called `Wikitext`, but for this project, encyclopedia entries are stored using a markup language called [Markdown](https://docs.github.com/en/github/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax).
