...
def register(request):
    if request.method == 'POST':
        ...
        if password != confirmation:
            return render(request, 'foodtracker/register.html', {
...
def login_view(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            return render(request, 'foodtracker/login.html', {
...
def food_details_view(request, food_id):
    ...
    return render(request, 'foodtracker/food.html', {
        'categories': FoodCategory.objects.all(),
        'food': food,
...
def food_add_view(request):
    ...
    if request.method == 'POST':
        ...
        if food_form.is_valid() and image_form.is_valid():
            ...
            return render(request, 'foodtracker/food_add.html', {
                'categories': FoodCategory.objects.all(),
                'food_form': FoodForm(),
...
def food_log_view(request):
    ...
    return render(request, 'foodtracker/food_log.html', {
        'categories': FoodCategory.objects.all(),
        'foods': foods,
...
def food_log_delete(request, food_id):
    ...
    return render(request, 'foodtracker/food_log_delete.html', {
        'categories': FoodCategory.objects.all()
    })
...
def weight_log_view(request):
    ...
    return render(request, 'foodtracker/user_profile.html', {
        'categories': FoodCategory.objects.all(),
...
def weight_log_delete(request, weight_id):
    ...
    return render(request, 'foodtracker/weight_log_delete.html', {
        'categories': FoodCategory.objects.all()
    })
...
def categories_view(request):
    ...
    '''
    return render(request, 'foodtracker/categories.html', {
        'categories': FoodCategory.objects.all()
    })
...
def category_details_view(request, category_name):
    ...
    return render(request, 'foodtracker/food_category.html', {
        'categories': FoodCategory.objects.all(),
        'foods': foods,
